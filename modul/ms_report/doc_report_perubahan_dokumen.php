...
<div class="portlet box <?php echo $dataPanel; ?>">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase bold">Laporan Perubahan Dokumen Tgl. Usulan</span></div>
		<div class="tools">
		...
		<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" class="form-horizontal form-bordered">
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<select name="cmbKategori" data-placeholder="- Pilih Subject -" class="select2 form-control">
							<option value=""></option> 
							<?php
								  $dataSql = "SELECT * FROM doc_ms_kat_doc ORDER BY doc_ms_kat_doc_id DESC";
								  $dataQry = mysqli_query($koneksidb, $dataSql) or die ("Gagal Query".mysqli_errors());
								  while ($dataRow = mysqli_fetch_array($dataQry)) {
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<select name="cmbSubject" data-placeholder="- Pilih Subject -" class="select2 form-control">
							<option value=""></option> 
							<?php
								  $dataSql = "SELECT * FROM doc_ms_jns_doc ORDER BY doc_ms_jns_doc_id DESC";
								  $dataQry = mysqli_query($koneksidb, $dataSql) or die ("Gagal Query".mysqli_errors());
								  while ($dataRow = mysqli_fetch_array($dataQry)) {
				...
				<div class="form-group">
					<label class="col-md-2 control-label">Status Usulan :</label>
					<div class="col-md-2">
				...
				<div class="form-group last">
					<label class="col-md-2 control-label">Output Type :</label>
					<div class="col-md-3">
