<?php
	if(isset($_POST['btnExport'])){
		...
		if (trim($_POST['cmbKendaraan'])=="") {
			$message[] = "Data jenis kendaraan tidak boleh kosong!";		
		}
		if (trim($_POST['cmbPetugas'])=="") {
			$message[] = "Data petugas tidak boleh kosong!";		
		}
		if (trim($_POST['cmbKlasifikasi'])=="") {
			$message[] = "Data kelasifikasi muatan tidak boleh kosong!";		
		}
		...
		if(count($message)==0){		
			...
			echo '<script>window.open("./output/load_report_out.php?tgl1='.$tgl1.'&tgl2='.$tgl2.'&jns='.$jns.'&act='.$act.'&ptgs='.$ptgs.'&kls='.$kls.'","_blank")</script>';
...
<div class="portlet box <?php echo $dataPanel; ?>">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase bold">Laporan Bongkar/Muat Berdasarkan Tgl. Keluar</span></div>
		<div class="tools">
