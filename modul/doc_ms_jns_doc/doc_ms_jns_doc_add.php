<?php
	...
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){
			$sqlSave="INSERT INTO doc_ms_jns_doc (doc_ms_jns_doc_nm,
												doc_ms_jns_doc_kd,
												doc_ms_jns_doc_ket,
												doc_ms_jns_doc_sts,
												doc_ms_jns_doc_tingkat,
												doc_ms_jns_doc_created,
												doc_ms_jns_doc_createdby)
										VALUES('$txtNama',
												'$txtKode',
												'$txtKeterangan', 
												'$cmbStatus',
			...
			if($qrySave){
				...
				$_SESSION['pesan'] = 'Data jenis dokumen berhasil ditambahkan';
	...
	$dataTingkat	= isset($_POST['txtTingkat']) ? $_POST['txtTingkat'] : ''; 
?>
