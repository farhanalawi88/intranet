<?php
	...
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){
			$sqlSave="INSERT INTO sys_employee  (nik,
												 nama_karyawan,
												 keterangan,
												 status,
												 created,
        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal form-bordered" autocomplete="off">
        	<div class="form-body">
		        <div class="form-group">
					...
					<div class="col-lg-4">
						<input type="text" name="txtNik" value="<?php echo $dataNik; ?>" class="form-control" placeholder="Enter NIK" onkeyup="javascript:this.value=this.value.toUpperCase();"/>
		             </div>
				</div>
				<div class="form-group">
