<?php
	...
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){
			$sqlSave="INSERT INTO ptkp_ms_dampak (ptkp_ms_dampak_nm,
												ptkp_ms_dampak_ket,
												ptkp_ms_dampak_sts,
												ptkp_ms_dampak_created,
												ptkp_ms_dampak_createdby)
										VALUES('$txtNama',
												'$txtKeterangan', 
												'$cmbStatus',
												'".date('Y-m-d H:i:s')."',
			...
			if($qrySave){
				...
				$_SESSION['pesan'] = 'Data dampak temuan ptkp berhasil ditambahkan';
