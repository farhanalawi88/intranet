<?php
	...
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){
			$sqlSave="INSERT INTO ptkp_ms_terkait (ptkp_ms_terkait_nm,
												ptkp_ms_terkait_ket,
												ptkp_ms_terkait_sts,
												ptkp_ms_terkait_created,
												ptkp_ms_terkait_createdby)
										VALUES('$txtNama',
												'$txtKeterangan', 
												'$cmbStatus',
												'".date('Y-m-d H:i:s')."',
			...
			if($qrySave){
				...
				$_SESSION['pesan'] = 'Data keterkaitan temuan ptkp berhasil ditambahkan';
