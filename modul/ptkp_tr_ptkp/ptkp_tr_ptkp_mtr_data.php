<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
	<div class="portlet box <?php echo $dataPanel; ?>">
	    <div class="portlet-title">
	        <div class="caption">
	            <span class="caption-subject uppercase bold">Data Monitoring PTKP</span>
	        </div>
	        <div class="tools">
           ...
           <table class="table table-striped table-hover table-checkable order-column" id="sample_2">
               ...
               <?php
						$dataSql = "SELECT 
									...
									WHERE a.ptkp_tr_ptkp_tindakan='Y'
				...
				?>
                    <tr class="odd gradeX">
						...
						<td><div align="center"><a href="?page=<?php echo base64_encode(ptkpaddmonitortrptkp) ?>&amp;id=<?php echo base64_encode($Kode); ?>" class="btn btn-xs <?php echo $dataPanel; ?>"><i class="fa fa-edit"></i></a></div></td>
                    </tr>
                    <?php } ?>
				</tbody>
            </table>
