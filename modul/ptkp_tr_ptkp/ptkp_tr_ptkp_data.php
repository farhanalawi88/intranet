...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
	<div class="portlet box <?php echo $dataPanel; ?>">
	    <div class="portlet-title">
	        <div class="caption">
	            <span class="caption-subject uppercase bold">Data Pembuatan PTKP</span>
	        </div>
	        <div class="actions">
				<a href="?page=<?php echo base64_encode(ptkpaddtrptkp) ?>" class="btn <?php echo $dataPanel; ?> active"><i class="icon-plus"></i> ADD DATA </a>
           ...
           <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
               ...
               <?php
						$dataSql = "SELECT 
									...
									WHERE a.ptkp_tr_ptkp_createdby='".$userRow['sys_role_id']."'
				...
				?>
                    <tr class="odd gradeX">
						...
						<td><div align="center"><a href="?page=<?php echo base64_encode(ptkpedttrptkp) ?>&amp;id=<?php echo base64_encode($Kode); ?>" class="btn btn-xs <?php echo $dataPanel; ?>"><i class="fa fa-pencil"></i></a></div></td>
                    </tr>
                    <?php
