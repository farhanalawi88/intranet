<?php
	...
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){
			...
			if($qrySave){
				...
				$_SESSION['pesan'] = 'Data sumber PTKP berhasil diperbaharui';
	...
	$sqlShow			= "SELECT * FROM ptkp_ms_sumber WHERE ptkp_ms_sumber_id='$KodeEdit'";
	$qryShow 			= mysqli_query($koneksidb, $sqlShow)  or die ("Query ambil data department salah : ".mysqli_errors());
	$dataShow			= mysqli_fetch_array($qryShow);
	
	$dataID				= $dataShow['ptkp_ms_sumber_id'];
	    	...
	    	<div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-2 col-md-10">
		                ...
		                <a href="?page=<?php echo base64_encode(ptkpdtmssumber) ?>" class="btn <?php echo $dataPanel; ?>"><i class="fa fa-undo"></i> Batalkan</a>
			        </div>
			    </div>
			</div>
		</form>
