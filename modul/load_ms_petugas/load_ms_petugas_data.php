<?php
	...
	if(isset($_POST['btnHapus'])){
		...
		foreach ($txtID as $id_key) {
			...
			$hapus=mysqli_query($koneksidb, "DELETE FROM load_ms_petugas WHERE load_ms_petugas_id='$id_key'");
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
	<div class="portlet box <?php echo $dataPanel; ?>">
		...
		<div class="caption"><span class="caption-subject uppercase bold">Data Petugas</span></div>
			<div class="actions">
			...
			<table class="table table-bordered table-hover table-checkable order-column" id="sample_2">
				...
				<tbody>
                    <?php
						...
						$nomor++;
						$Kode = $data['load_ms_petugas_id'];
						if($data['load_ms_petugas_sts']=='Y'){
                   ...
                   <tr>
						...
						<td><?php echo $data ['load_ms_petugas_nm']; ?></td>
