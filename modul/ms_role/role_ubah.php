<?php
	...
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){	
			...
			$sqlSave="UPDATE sys_role SET ad_user_id='$cmbID', 
										...
										sys_role_nama='$txtNama',
										sys_role_username='$txtUsername',
										sys_role_password='$txtPassword',
										sys_role_home='$txtHome',
										sys_bagian_id='$cmbBagian',
										sys_org_id='$cmbOrg',
										sys_jab_id='$cmbJab',
										sys_role_updated='".date('Y-m-d H:i:s')."'
									WHERE sys_role_id='".$_POST['txtKode']."'";
			$qrySave=mysqli_query($koneksidb, $sqlSave);
			if($qrySave){
				$_SESSION['info'] = 'success';
				$_SESSION['pesan'] = 'Data role user berhasil diperbaharui';
	...
	$sqlShow 		= "SELECT * FROM sys_role a 
						WHERE a.sys_role_id='".base64_decode($KodeEdit)."'";
	...
	$dataID			= isset($_POST['cmbID']) ? $_POST['cmbID'] : $dataShow['ad_user_id'];
	$dataNama		= isset($_POST['txtNama']) ? $_POST['txtNama'] : $dataShow['sys_role_nama'];
	$dataUsername	= isset($_POST['txtUsername']) ? $_POST['txtUsername'] : $dataShow['sys_role_username'];
	$dataPassword	= isset($_POST['txtPassword']) ? $_POST['txtPassword'] : $dataShow['sys_role_password'];
	$dataGroup		= isset($_POST['cmbGroup']) ? $_POST['cmbGroup'] : $dataShow['sys_group_id'];
	$dataStatus		= isset($_POST['cmbStatus']) ? $_POST['cmbStatus'] : $dataShow['sys_role_sts'];
	$dataHome		= isset($_POST['txtHome']) ? $_POST['txtHome'] : $dataShow['sys_role_home'];
	...
	$dataJab		= isset($_POST['cmbJab']) ? $_POST['cmbJab'] : $dataShow['sys_jab_id'];
?>
<div class="portlet box <?php echo $dataPanel; ?>">
	<div class="portlet-title">
		<div class="caption">
            <span class="caption-subject uppercase bold">Perubahan Role User</span>
        </div>
		<div class="tools">
            	...
            	<table class="table table-hover table-bordered table-striped table-condensed" width="100%" id="sample_2">
		            ...
		            <tbody>
		                ...
		                $query = pg_query($koneksipg, "SELECT 
															...
															a.password
															FROM
																ob.obsutrado.[public].ad_user a
																LEFT JOIN ob.obsutrado.[public].gmm_departement b ON a.em_gmm_departement_id= b.gmm_departement_id 
															WHERE
																NOT a.username= '' 
															ORDER BY
																a.ad_user_id DESC");
