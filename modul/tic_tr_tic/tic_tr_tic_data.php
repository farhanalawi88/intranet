		...
		<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
				...
				<tbody>
                   ...
                   <tr class="odd gradeX">
						...
						<td><div align="center">
							<div class="btn-group">
								<a href="?page=<?php echo base64_encode(ticedttic) ?>&amp;id=<?php echo $Kode; ?>" class="btn blue btn-xs <?php echo $disabled ?>"><i class="fa fa-pencil"></i></a>
								<a href="./output/rpt_form_ba.php?id=<?php echo $Kode; ?>" target="_BANK" class="btn green btn-xs <?php echo $disabled ?>"><i class="fa fa-print"></i></a>
							</div>
							</div>
						</td>
                    </tr>
